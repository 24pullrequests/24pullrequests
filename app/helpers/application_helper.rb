module ApplicationHelper
  ...
  def gravatar_url(digest, size = '80')
    digest ||= ''
    "https://secure.gravatar.com/avatar/#{digest}.png?s=#{size}&d=https://" +
    "a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2F" +
    "gravatar-user-420.png"
  end

  def github_button(nickname)
    %(<iframe src="http://ghbtns.com/github-btn.html?user=#{nickname}&" +
    "type=follow&count=true" allowtransparency="true" frameborder="0"
    scrolling="0" width="300" height="20"></iframe>).html_safe
  end
end
