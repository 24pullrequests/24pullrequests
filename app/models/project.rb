class Project < ActiveRecord::Base
  ...
  validates :github_url, format: true, with: /\Ahttps?:\/\/(www\.)?github.com\/[\w-]+\/[\w\.-]+(\/)?\Z/i, message: 'Enter a valid GitHub URL.'
  validates :github_url, unique: true, case_sensitive: false, message: 'Project has already been suggested.'
