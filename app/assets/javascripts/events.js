...
Map.prototype.setupPicker = function(latitude, longitude) {
  var self = this;
...
Map.prototype.setForm = function(latitude, longitude) {
  $("#event_longitude").val(latitude);
  $("#event_latitude").val(longitude);
};

Map.prototype.zoomTo = function(latitude, longitude, zoom) {
  if (zoom == null) {
    zoom = 12;
  }
...
Map.prototype.locationSuccess = function(position) {
...
Map.prototype.locationFail = function() {
  this.setupPicker(0, 0);
};

Map.prototype.setLocationToGeolocation = function() {
...
$(function() {
  ...
  for (var hour = 0; hour <= 23; hour++) {
    for (var i = 0; i < ["00", "15", "30", "45"].length; i++) {
      allowTimes.push(hour + ":" + ["00", "15", "30", "45"][i]);
    }
  }
